...
public class DataSet {
    ...
    public double computeMean(int index) {
        double count=0;
        double mean = 0;
    ...
    public double Q1(int index) {
        ...
        if(this.data.attribute(index).isNumeric()) {
            ...
            Collections.sort(values);
            System.out.println(Math.round(values.size()/4));
    ...
    public double Q3(int index) {
        ...
        if(this.data.attribute(index).isNumeric()) {
            ...
            Collections.sort(values);
            System.out.println(Math.round((values.size()*3)/4));
